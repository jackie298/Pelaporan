            ...
            <div class="form-card">
                <div class="card-header">
                    <h5>
                        ...
                        Form Tambah Data Revegetasi
                    </h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('revegetasi.store') }}" method="POST" id="createForm">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="tingkat_keberhasilan"
                                    ...
                                    <option value="rendah" {{ old('tingkat_keberhasilan') == 'rendah' ? 'selected' : '' }}>❌ Rendah</option>
                                    <option value="sedang" {{ old('tingkat_keberhasilan') == 'sedang' ? 'selected' : '' }}>⚠️ Sedang</option>
                                    <option value="tinggi" {{ old('tingkat_keberhasilan') == 'tinggi' ? 'selected' : '' }}>✅ Tinggi</option>
                                </select>
                                <small class="form-hint">
