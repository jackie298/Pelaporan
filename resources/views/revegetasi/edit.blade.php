    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mx-4">
                ...
                <div class="card-body">
                    <form action="{{ route('revegetasi.update', $data->id) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="jenis_vegetasi"
                                    ...
                                    <option value="pionir" {{ old('jenis_vegetasi', $data->jenis_vegetasi) == 'pionir' ? 'selected' : '' }}>
                                        Pionir
                                    </option>
                                    <option value="lokal" {{ old('jenis_vegetasi', $data->jenis_vegetasi) == 'lokal' ? 'selected' : '' }}>
                                        Lokal
                                    </option>
                                    <option value="covercrop" {{ old('jenis_vegetasi', $data->jenis_vegetasi) == 'covercrop' ? 'selected' : '' }}>
                                        Covercrop
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="tingkat_keberhasilan"
                                    ...
                                    <option value="rendah" {{ old('tingkat_keberhasilan', $data->tingkat_keberhasilan) == 'rendah' ? 'selected' : '' }}>
                                        Rendah
                                    </option>
                                    <option value="sedang" {{ old('tingkat_keberhasilan', $data->tingkat_keberhasilan) == 'sedang' ? 'selected' : '' }}>
                                        Sedang
                                    </option>
                                    <option value="tinggi" {{ old('tingkat_keberhasilan', $data->tingkat_keberhasilan) == 'tinggi' ? 'selected' : '' }}>
                                        Tinggi
                                    </option>
                                </select>
