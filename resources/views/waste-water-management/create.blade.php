            ...
            <div class="card form-card">
                <div class="card-header">
                    <h5>
                        ...
                        Form Tambah Data Air Limbah
                    </h5>
                    <p class="mb-0">Silakan lengkapi seluruh parameter pemantauan air limbah di bawah ini.</p>
                </div>

                <div class="card-body">
                    <form action="{{ route('waste-water-management.store') }}" method="POST" id="wasteWaterForm">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group" style="--i: 1">
                                ...
                                <input type="date"
                                       ...
                                       value="{{ old('tanggal_sampling', date('Y-m-d')) }}"
                            ...
                            <div class="col-md-6 form-group" style="--i: 3">
                                ...
                                <div class="radio-group">
                                    <div class="radio-option">
                                        <input type="radio" name="sampler" id="inlet" value="inlet" {{ old('sampler') == 'inlet' ? 'checked' : '' }} required>
                                        <label for="inlet">
                                    ...
                                    <div class="radio-option">
                                        <input type="radio" name="sampler" id="outlet" value="outlet" {{ old('sampler', 'outlet') == 'outlet' ? 'checked' : '' }} required>
                                        <label for="outlet">
