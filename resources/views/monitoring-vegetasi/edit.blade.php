        ...
        <div class="col-12">
            ...
            <div class="card mx-4">
                <div class="card-header pb-0">
                    <h5 class="mb-0">Form Edit Data Monitoring Vegetasi</h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('monitoring-vegetasi.update', $data->id) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Tinggi triwulan1 (cm)</label>
                                <input type="number"
                                       step="0.01"
                            ...
                            {{-- TINGGI triwulan2 --}}
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Tinggi triwulan2 (cm)</label>
                                <input type="number"
                                       step="0.01"
                            ...
                            {{-- TINGGI triwulan3 --}}
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Tinggi triwulan3 (cm)</label>
                                <input type="number"
                                       step="0.01"
                            ...
                            {{-- TINGGI triwulan4 --}}
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Tinggi triwulan4 (cm)</label>
                                <input type="number"
                                       step="0.01"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="catatan"
                                          ...
                                          placeholder="Catatan tambahan tentang kondisi tanaman atau pengamatan lapangan">{{ old('catatan', $data->catatan) }}</textarea>
