        ...
        <div class="col-12">
            ...
            <div class="card mx-4">
                <div class="card-header pb-0">
                    <h5 class="mb-0">Form Tambah Data Bukaan Lahan</h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('bukaan-lahan.store') }}"
                          method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="alat_berat_digunakan"
                                          ...
                                          placeholder="Contoh: Excavator PC300, Dump Truck HD785">{{ old('alat_berat_digunakan') }}</textarea>
