            ...
            <div class="form-card">
                <div class="card-header">
                    <h5>
                        ...
                        Form Edit Data Bukaan Lahan
                    </h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('bukaan-lahan.update', $data->id) }}" method="POST" id="editForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="alat_berat_digunakan"
                                          ...
                                          maxlength="500"
                                          oninput="updateCharCounter(this, 'alatCounter')">{{ old('alat_berat_digunakan', $data->alat_berat_digunakan) }}</textarea>
