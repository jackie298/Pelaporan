...
<div class="main-content-wrapper">
    ...
    <div class="custom-header">
        <div class="d-md-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="text-white font-weight-bolder mb-0">Tambah Equipment</h4>
                    <p class="text-white opacity-8 text-sm">Input data peralatan dan alat berat baru</p>
                </div>
            </div>
    ...
    <div class="card form-card mx-3 mb-4">
        <div class="card-header border-bottom-0 pb-0 pt-4 px-4">
            ...
            <p class="text-sm text-muted mb-0 mt-1">Lengkapi informasi berikut untuk menambahkan equipment baru</p>
        </div>

        <div class="card-body px-4 pb-4">
            <form action="{{ route('admin.equipment-list.store') }}" method="POST" id="equipmentForm">
                @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group-custom">
                                ...
                                <input type="text" name="jenis" list="jenisList"
                                       ...
                                       placeholder="Pilih atau ketik jenis" required>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-custom">
                                ...
                                <select name="status" class="form-control @error('status') is-invalid @enderror" id="statusSelect" required>
                                    <option value="">-- Pilih Status --</option>
                                    <option value="tersedia" {{ old('status') == 'tersedia' ? 'selected' : '' }}>Tersedia</option>
                                    <option value="dipakai" {{ old('status') == 'dipakai' ? 'selected' : '' }}>Sedang Dipakai</option>
                                    <option value="perawatan" {{ old('status') == 'perawatan' ? 'selected' : '' }}>Dalam Perawatan</option>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="catatan" rows="4"
                                      ...
                                      placeholder="Tambahkan catatan penting mengenai equipment ini...">{{ old('catatan') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // === Reset form after successful submit (optional UX enhancement) ===
