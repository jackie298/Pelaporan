                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="jenis_tanaman"
                                    ...
                                    <option value="pionir" {{ old('jenis_tanaman', $data->jenis_tanaman) == 'pionir' ? 'selected' : '' }}>
                                        Pionir
                                    </option>
                                    <option value="lokal" {{ old('jenis_tanaman', $data->jenis_tanaman) == 'lokal' ? 'selected' : '' }}>
                                        Lokal
                                    </option>
                                    <option value="covercrop" {{ old('jenis_tanaman', $data->jenis_tanaman) == 'covercrop' ? 'selected' : '' }}>
                                        Covercrop
                                    </option>
                                </select>
                                @error('jenis_tanaman')
