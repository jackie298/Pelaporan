        ...
        <div class="col-12">
            <div class="form-card">
                <div class="card-header">
                    <h5><i class="fas fa-edit"></i> Form Tambah Data Reklamasi</h5>
                </div>

                <div class="card-body">
                    {{-- FORM: Tanpa novalidate, tanpa JS kompleks --}}
                    <form action="{{ route('reklamasi.store') }}" method="POST" id="createForm">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="alat_berat_digunakan" name="alat_berat_digunakan" rows="2"
                                          ...
                                          placeholder="Contoh: Dozer D85">{{ old('alat_berat_digunakan') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="status_kesesuaian" name="status_kesesuaian" 
                                    ...
                                    <option value="sesuai" {{ old('status_kesesuaian') == 'sesuai' ? 'selected' : '' }}>✅ Sesuai</option>
                                    <option value="tidak_sesuai" {{ old('status_kesesuaian') == 'tidak_sesuai' ? 'selected' : '' }}>❌ Tidak Sesuai</option>
                                </select>
