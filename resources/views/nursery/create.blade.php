...
<div class="container-fluid py-4">
    ...
    <div class="alert-header">
        <span class="text-white">
            ...
            <strong>Tambah Data Pembibitan</strong>
        </span>
    </div>
            ...
            <div class="form-card">
                <div class="card-header">
                    <h5>
                        ...
                        Form Tambah Data Pembibitan
                    </h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('nursery.store') }}" method="POST" id="createForm">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="status_pertumbuhan"
                                    ...
                                    <option value="bagus" {{ old('status_pertumbuhan') == 'bagus' ? 'selected' : '' }}>
                                        ✅ Bagus
                                    </option>
                                    <option value="sedang" {{ old('status_pertumbuhan') == 'sedang' ? 'selected' : '' }}>
                                        ⚠️ Sedang
                                    </option>
                                    <option value="buruk" {{ old('status_pertumbuhan') == 'buruk' ? 'selected' : '' }}>
                                        ❌ Buruk
                                    </option>
                                </select>
                                <small class="form-hint">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number"
                                           ...
                                           value="{{ old('persentase_keberhasilan') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date"
                                       ...
                                       value="{{ old('estimasi_siap_tanam') }}"
                                       class="form-control @error('estimasi_siap_tanam') is-invalid @enderror"
                                       min="{{ old('tanggal_penyemaian') ?? date('Y-m-d') }}">
                                <small class="form-hint">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="catatan"
                                          ...
                                          maxlength="1000"
                                          oninput="updateCharCounter(this, 'catatanCounter')">{{ old('catatan') }}</textarea>
