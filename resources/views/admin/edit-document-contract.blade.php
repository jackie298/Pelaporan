    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mx-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.document-contract.update', $contract->id) }}"
                          method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       name="realisasi"
                                       value="{{ old('realisasi', $contract->realisasi) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="keterangan_jasa"
                                          ...
                                          placeholder="Deskripsi jasa pekerjaan">{{ old('keterangan_jasa', $contract->keterangan_jasa) }}</textarea>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number"
                                       name="harga"
                                       value="{{ old('harga', $contract->harga) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text"
                                       name="keterangan"
                                       value="{{ old('keterangan', $contract->keterangan) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="uraian_rkab"
                                          ...
                                          placeholder="Uraian RKAB">{{ old('uraian_rkab', $contract->uraian_rkab) }}</textarea>
