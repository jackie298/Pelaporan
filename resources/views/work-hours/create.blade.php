...
<div class="container-fluid py-4">
    ...
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            <strong>Tambah Jam Kerja</strong>
        </span>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="card mx-4">
                <div class="card-header pb-0">
                    <h5 class="mb-0">Form Tambah Data Jam Kerja</h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.work-hours.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="aktivitas"
                                          ...
                                          placeholder="Deskripsi kegiatan">{{ old('aktivitas') }}</textarea>
