...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .total-display .total-label i {
        color: #2dce89; font-size: 1.1rem;
    }
    ...
    @media (max-width: 767px) {
        .alert-bar, .form-card { margin-left: 12px; margin-right: 12px; }
...
<div class="form-page">
    ...
    <div class="form-card">
        <div class="card-header">
            <h5><i class="fas fa-clipboard-list"></i>Form Input Data</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('trash-management.store') }}" method="POST" id="trashForm" novalidate>
                @csrf
                ...
                <div class="row g-4">
                    ...
                    {{-- ROW 2: Weight Inputs (Cards) --}}
                    <div class="col-12">
                        <label class="form-label mb-2">
                            <i class="fas fa-weight-hanging"></i> Berat Sampah (kg)
                            <small class="text-muted ms-2" style="font-weight: 400; text-transform: none;">
                                (Isi minimal satu jenis)
                            </small>
                        </label>
                        ...
                        <div class="weight-grid">
                            ...
                            <div class="weight-card organik">
                                ...
                                <input type="number" name="sampah_organik_terpilah" 
                                       class="weight-input" 
                                       value="{{ old('sampah_organik_terpilah', '') }}"
                                       min="0" placeholder="0"
                            ...
                            <div class="weight-card anorganik">
                                ...
                                <input type="number" name="sampah_anorganik_terpilah" 
                                       class="weight-input" 
                                       value="{{ old('sampah_anorganik_terpilah', '') }}"
                                       min="0" placeholder="0"
                            ...
                            <div class="weight-card residu">
                                ...
                                <input type="number" name="sampah_lainnya_dan_atau_residu" 
                                       class="weight-input" 
                                       value="{{ old('sampah_lainnya_dan_atau_residu', '') }}"
                                       min="0" placeholder="0"
                    ...
                    <div class="col-12">
                        <div class="total-display">
                            ...
                            <small class="total-hint">
                                ...
                                Total dihitung otomatis dari ketiga jenis sampah di atas
                            </small>
                        </div>
                    ...
                    <div class="col-12">
                        <label class="form-label">
                            ...
                            <small class="text-muted ms-2" style="font-weight: 400; text-transform: none;">(Opsional)</small>
                        </label>
                        <textarea name="catatan" 
                                  class="form-control @error('catatan') is-invalid @enderror"
                                  rows="3" 
                                  placeholder="Contoh: Sampah diambil oleh pihak ketiga, kondisi khusus, dll...">{{ old('catatan') }}</textarea>
                        @error('catatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form?.addEventListener('submit', function(e) {
        ...
        const sumber = document.querySelector('[name="sumber_sampah"] option:checked').text;
    ...
    // Auto-format number inputs on blur (optional UX enhancement)
    Object.values(inputs).forEach(input => {
        input?.addEventListener('blur', function() {
            if (this.value) {
                const num = parseInt(this.value) || 0;
                // Keep raw value for form submission, just visual hint
                this.title = `${formatNumber(num)} kg`;
            }
        });
    });
});
